...
/** Explicit exceptions only; regular forms are generated by the English matcher. */
export type WordForms = Partial<Record<WordFormType, string[]>> & {
  /** Suppress unsafe generated categories, e.g. modal `can` has no `cans`. */
  disableGenerated?: WordFormType[]
}
