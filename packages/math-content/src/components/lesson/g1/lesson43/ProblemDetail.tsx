...
import { TAG_STYLE } from '@rosie/math-content/utils/g1/lesson43-data'
...
export default function ProblemDetail({
  ...
  const { practiceCount, correctCount, handleSolve, addWrong } = useG1Lesson43()
  ...
  const solution = <ProblemSolutionPanel problem={problem} variant="cyan" />
  ...
  const question = (
    <div className="flex flex-col gap-1.5">
      <div className="min-w-0 flex-1">
        ...
        <div
          className="text-text-secondary [&>strong]:text-text-primary mb-3.5 rounded-lg border-l-3 border-cyan-300 bg-cyan-50 px-3.5 py-3 text-sm leading-relaxed [&>strong]:font-bold"
