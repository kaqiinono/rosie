...
const CONFIG = { basePath: BASE, activeClass: 'bg-amber-50 font-bold text-amber-700', sections: [{ key: 'lesson', path: `${BASE}/lesson`, icon: '📖', label: '课堂讲解' }, { key: 'homework', path: `${BASE}/homework`, icon: '✏️', label: '课后巩固' }, { key: 'alltest', path: `${BASE}/alltest`, icon: '🎯', label: '综合题库' }], extraLinks: [] } as const
