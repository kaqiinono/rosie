  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-purple-200 bg-gradient-to-br from-purple-50 to-[#ede9fe] p-4">
        <div className="mb-1 text-sm font-extrabold text-purple-900">📚 拓展练习 · 第13讲</div>
        <div className="mb-2 text-xs text-purple-700">{total}道闯关题 · 综合挑战 + 行程与速度</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/13/workbook" />
    </div>
  )
}
