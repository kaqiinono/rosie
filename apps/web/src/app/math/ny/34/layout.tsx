...
import Lesson34Provider, { useLesson34 } from '@rosie/math/components/lesson34/Lesson34Provider'
import AppHeader from '@rosie/math/components/lesson34/AppHeader'
import Sidebar from '@rosie/math/components/lesson34/Sidebar'
import BottomNav from '@rosie/math/components/lesson34/BottomNav'
...
function getNextHref(pathname: string): string | undefined {
  // pathname: /math/ny/34/{section}/{index}
  ...
  return `/math/ny/34/${section}/${index + 1}`
}

function InnerLayout({ children }: { children: React.ReactNode }) {
  const { toast, setToast, showCongrats, setShowCongrats } = useLesson34()
...
export default function Lesson34Layout({ children }: { children: React.ReactNode }) {
  return (
    <Lesson34Provider>
