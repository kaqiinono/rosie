...
export default function AdminNewMathPlanPage() {
  return (
    <div
    ...
    >
      ...
      >
        <div className="mx-auto flex h-14 max-w-[800px] items-center gap-3 pl-[52px] pr-4 sm:pl-[60px]">
          <Link
          ...
          <span className="text-[17px] font-extrabold text-orange-800">新建数学计划</span>
        </div>
      </div>
      <MathWeeklyPlanEditor problemSets={MATH_PLAN_PROBLEM_SETS} />
    </div>
  )
}
