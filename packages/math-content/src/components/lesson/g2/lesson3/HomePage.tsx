...
import { PROBLEM_TYPES, TYPE_STYLE } from '@rosie/math-content/utils/g2/lesson3-data'
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-1.5">
              <div className="relative h-1 flex-1 overflow-hidden rounded-sm bg-gray-100">
                <div
                  className="absolute inset-y-0 left-0 rounded-sm bg-emerald-200 transition-[width] duration-500"
                  style={{
                    width: `${totalAll > 0 ? Math.round((attemptedAll / totalAll) * 100) : 0}%`,
                  }}
                />
                <div
                  className="absolute inset-y-0 left-0 rounded-sm bg-emerald-500 transition-[width] duration-500"
                  style={{
