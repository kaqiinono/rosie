...
const L4_PUZZLE: VerticalDigitPuzzleSpec = {
  ...
  result: [null, null, 2, 2, 2],
  solutionFills: { b0: 3, b1: 9, b2: 3, b3: 4, b4: 1, b5: 0 },
}
...
const L9_PUZZLE: VerticalDigitPuzzleSpec = {
  op: '+',
  operands: [
    [C('赛'), C('杯'), C('趣'), C('兴'), C('学'), C('数'), C('届'), C('二'), C('第')],
    [8, 6, 4, 1, 9, 7, 5, 3, 2],
  ],
...
export const PROBLEM_TYPES = [
  {
    ...
    color: 'sky',
    label: '题型1 · 加法数字谜',
    desc: '方框、字母、汉字、图形竖式加法。',
    example: '例：□53+3□3=852',
  },
  {
    tag: 'type2',
    color: 'indigo',
  ...
  },
  {
    ...
    color: 'violet',
    label: '题型3 · 数字和分析',
    desc: '在竖式成立前提下求填入数字之和。',
    example: '例：三数相加和为1089',
  },
  {
    tag: 'type5',
    color: 'purple',
...
const LESSON: Problem[] = [
  ...
  },
  {
    ...
    analysis: [
      '和为五位数且末三位是 222',
      '个位 8+□ 个位 2 → 需进位',
      '一组解：<strong>838+9384=10222</strong>',
    ],
    type: 'none',
    finalQ: '和是',
    finalUnit: '',
  ...
  },
  {
    ...
    analysis: [
      '两三位数之和为 1997',
      '最大 999+998=1997',
      '数字 9,9,9,9,8,8 之和 = <strong>52</strong>',
    ],
    type: 'none',
    finalQ: '六个数字之和是',
    finalUnit: '',
  ...
  },
  {
    ...
    analysis: [
      '4×"兴趣"="高兴"',
      '设兴=x，趣=y，高=z',
      '40x+4y=10z+x → 兴=2，趣=3，高=9',
      '4×23=<strong>92</strong>',
    ],
    type: 'none',
    finalQ: '"高"代表',
    finalUnit: '',
  ...
  },
  {
    ...
    analysis: [
      '三数相加得四位数，末两位 89',
      '要使填入数字之和最大，尽量用大数字',
      '981+99+9=1089，填入数字和 = <strong>46</strong>',
    ],
    type: 'none',
    finalQ: '填入数字之和最大是',
    finalUnit: '',
...
const PRETEST: Problem[] = [
  ...
  },
  {
    ...
    analysis: ['□=9，☆=8，且 △+○=8（互异、≠9、≠8）', '四符号之和恒为 <strong>25</strong>'],
    type: 'none',
    finalQ: '□+○+△+☆=',
    finalUnit: '',
    finalAns: 25,
  ...
  },
  {
    ...
    analysis: ['991+4072=5063 或 992+4071=5063', '两种解中 I 均为 <strong>3</strong>'],
    type: 'none',
    finalQ: 'I 代表',
    finalUnit: '',
    finalAns: 3,
