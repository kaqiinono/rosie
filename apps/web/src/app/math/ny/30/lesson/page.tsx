  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-amber-200 bg-gradient-to-br from-amber-50 to-[#fef3c7] p-4">
        <div className="mb-1 text-sm font-extrabold text-amber-900">📖 课堂讲解 · 第30讲</div>
        <div className="mb-2 text-xs text-amber-700">{total}道题 · 例题+练一练 · 6大题型进阶</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/30/lesson" />
    </div>
  )
}
