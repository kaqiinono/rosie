...
/** A → B 校园道路示意图（边权 = 分钟） */
export default function LessonFig12() {
  return (
    <svg viewBox="0 0 320 180" className="mx-auto h-auto w-full max-w-md">
      ...
      <text x="70" y="125" fontSize="11" fill="#4338ca">2</text>
      <line x1="125" y1="40" x2="195" y2="85" stroke={stroke} strokeWidth="2" />
      <text x="150" y="52" fontSize="11" fill="#4338ca">1</text>
      <line x1="125" y1="140" x2="195" y2="95" stroke={stroke} strokeWidth="2" />
      <text x="150" y="128" fontSize="11" fill="#4338ca">3</text>
      <line x1="125" y1="140" x2="274" y2="95" stroke={stroke} strokeWidth="2" strokeDasharray="4 3" />
      <text x="190" y="128" fontSize="11" fill="#4338ca">5</text>
      <line x1="205" y1="90" x2="274" y2="90" stroke={stroke} strokeWidth="2" />
      <text x="230" y="82" fontSize="11" fill="#4338ca">2</text>
    </svg>
  )
}
