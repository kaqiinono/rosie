...
const LESSON: Problem[] = [
  {
    id: '36-L1', title: '例题1(1)：过100天是星期几', tag: 'type1', tagLabel: '同月推算', difficulty: 1,
  ...
  {
    id: '36-L2', title: '例题1(2)：同月推算', tag: 'type1', tagLabel: '同月推算', difficulty: 1,
  ...
  {
    id: '36-L3', title: '例题2：跨月推算', tag: 'type2', tagLabel: '跨月推算', difficulty: 2,
  ...
  {
    id: '36-L4', title: '例题3：跨年推算元旦', tag: 'type3', tagLabel: '跨年推算（同月同日）', difficulty: 2,
  ...
  {
    id: '36-L5', title: '例题4：跨年跨月推算', tag: 'type4', tagLabel: '跨年跨月', difficulty: 2,
  ...
  {
    id: '36-L6', title: '例题5：31天确定31日星期几', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-L7', title: '例题6：由日期和确定第一个星期三', tag: 'type6', tagLabel: '日期总和反推', difficulty: 4,
...
const HOMEWORK: Problem[] = [
  {
    id: '36-H1', title: '课后巩固1：从日历推算4月1日', tag: 'type2', tagLabel: '跨月推算', difficulty: 3,
  ...
  {
    id: '36-H2', title: '课后巩固2：2008年奥运会是星期几', tag: 'type2', tagLabel: '跨月推算', difficulty: 3,
  ...
  {
    id: '36-H3', title: '课后巩固3：2022→2026年元旦', tag: 'type3', tagLabel: '跨年推算（同月同日）', difficulty: 3,
  ...
  {
    id: '36-H4', title: '课后巩固4：2025年8月→2026年10月', tag: 'type4', tagLabel: '跨年跨月', difficulty: 3,
  ...
  {
    id: '36-H5', title: '课后巩固5：由日期和确定第二个星期四', tag: 'type6', tagLabel: '日期总和反推', difficulty: 4,
  ...
  {
    id: '36-H6', title: '课后巩固6：31天确定20日星期几', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
...
const WORKBOOK: Problem[] = [
  {
    id: '36-W1', title: '闯关1：纳纳生日是星期几', tag: 'type1', tagLabel: '同月推算', difficulty: 3,
  ...
  {
    id: '36-W2', title: '闯关2：6月→9月跨月推算', tag: 'type2', tagLabel: '跨月推算', difficulty: 3,
  ...
  {
    id: '36-W3', title: '闯关3：2024→2026年10月', tag: 'type4', tagLabel: '跨年跨月', difficulty: 3,
  ...
  {
    id: '36-W4', title: '闯关4：2018→2021年元旦', tag: 'type3', tagLabel: '跨年推算（同月同日）', difficulty: 3,
  ...
  {
    id: '36-W5', title: '闯关5：2022年→2023年6月', tag: 'type4', tagLabel: '跨年跨月', difficulty: 3,
  ...
  {
    id: '36-W6', title: '闯关6：2015→2017年2月', tag: 'type4', tagLabel: '跨年跨月', difficulty: 3,
  ...
  {
    id: '36-W7', title: '闯关7：4月有5个周六和周日', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-W8', title: '闯关8：刚好3个星期日是偶数', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-W9', title: '闯关9：31天，4个周三和4个周日', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-W10', title: '闯关10：周二>周三，周一>周日，6号是星期几', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-W11', title: '闯关11：2006年53个周日，2007元旦是几', tag: 'type5', tagLabel: '确定星期几', difficulty: 5,
  ...
  {
    id: '36-W12', title: '闯关12：53个周二（元旦非周二），下一年最后一天', tag: 'type5', tagLabel: '确定星期几', difficulty: 5,
...
const PRETEST: Problem[] = [
  {
    id: '36-P1', title: '课前测1：9月→11月跨月推算', tag: 'type2', tagLabel: '跨月推算', difficulty: 1,
  ...
  {
    id: '36-P2', title: '课前测2：2022→2021年逆推', tag: 'type4', tagLabel: '跨年跨月', difficulty: 2,
  ...
  {
    id: '36-P3', title: '课前测3：2022→2025年4月1日', tag: 'type3', tagLabel: '跨年推算（同月同日）', difficulty: 2,
  ...
  {
    id: '36-P4', title: '课前测4：84集连续剧最后一集', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
  ...
  {
    id: '36-P5', title: '课前测5：5个周四和周六，16日是星期几', tag: 'type5', tagLabel: '确定星期几', difficulty: 4,
