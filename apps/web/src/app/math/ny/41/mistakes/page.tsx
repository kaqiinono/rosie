...
import { PROBLEMS, TAG_STYLE } from '@/utils/lesson41-data'
      ...
      {wrongList.length === 0 ? (
        ...
        <div className="flex flex-col gap-2">
          {wrongList.map(({ p, setName, idx }) => {
            ...
            const href = `/math/ny/41/${setName}/${idx + 1}`
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-0.5 flex flex-wrap gap-1">
                    ...
                    <span className="rounded-full bg-[#e0f2fe] px-2 py-px text-[10px] font-semibold text-[#0369a1]">
                      {srcLabel}
                    </span>
                    {count > 0 && (
