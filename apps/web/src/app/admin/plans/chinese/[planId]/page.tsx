...
export default function AdminEditChinesePlanPage() {
    ...
    >
      ...
      >
        <div className="mx-auto flex h-14 max-w-[720px] items-center gap-3 px-4">
          ...
          <span className="text-[17px] font-extrabold text-amber-900">编辑语文计划</span>
        </div>
      </div>
      <ChineseRoadmapPlanEditor editPlanId={planId} />
    </div>
  )
}
