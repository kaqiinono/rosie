        ...
        {tab === 'excel' ? (
            ...
            >
              {fileName ? (
                ...
                <>
                  ...
                  <div className="mt-0.5 text-[11px] text-slate-400">列顺序：Stage / Unit / Lesson / 单词 / 英文释义 / 中文释义 / 音标 / 例句 / phonics / 音节 / 关键词高亮 / 特殊词形 JSON / 词性</div>
                </>
              )}
              <input
                type="file"
          ...
          <div>
            <div className="mb-1 text-[12px] text-slate-500">
              ...
              <span className="font-bold">单元 · 课次 · 单词 · 英文释义 · 中文释义 · 音标 · 例句 · phonics · 音节 · 关键词高亮 · 特殊词形 JSON · 词性</span>
