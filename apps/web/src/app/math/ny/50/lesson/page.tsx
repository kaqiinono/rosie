  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-blue-200 bg-gradient-to-br from-blue-50 to-[#dbeafe] p-4">
        <div className="mb-1 text-sm font-extrabold text-blue-900">📖 课堂讲解 · 第50讲</div>
        <div className="mb-2 text-xs text-blue-700">{total}道例题 · 交换律结合律 / 去括号 / 按位相加 / 基准数</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/50/lesson" />
    </div>
  )
}
