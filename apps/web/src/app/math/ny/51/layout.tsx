...
import Lesson51Provider, { useLesson51 } from '@rosie/math/components/lesson51/Lesson51Provider'
import AppHeader from '@rosie/math/components/lesson51/AppHeader'
import Sidebar from '@rosie/math/components/lesson51/Sidebar'
import LessonInnerLayout from '@rosie/math/components/shared/LessonInnerLayout'
import BottomNav from '@rosie/math/components/lesson51/BottomNav'
...
function getNextHref(pathname: string): string | undefined {
  ...
  return `/math/ny/51/${section}/${index + 1}`
}

function InnerLayout({ children }: { children: React.ReactNode }) {
  const { toast, setToast, showCongrats, setShowCongrats } = useLesson51()
...
export default function Lesson51Layout({ children }: { children: React.ReactNode }) {
  return (
    <Lesson51Provider>
