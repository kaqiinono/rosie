...
export default createFilterPanel({
  ...
  theme: {
    ...
    containerGradient: 'bg-gradient-to-br from-sky-50 to-cyan-50',
  ...
  typeBtns: [
    { key: 'type1', label: '题型1·基本差倍' },
    { key: 'type2', label: '题型2·移多补少' },
    { key: 'type3', label: '题型3·年龄问题' },
    { key: 'type4', label: '题型4·几何和倍' },
