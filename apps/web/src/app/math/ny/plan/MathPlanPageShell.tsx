...
type MathPlanPageShellProps = {
  /** `/practice` passes true to jump into today's first unfinished problem. */
  autoStart?: boolean
}

export default function MathPlanPageShell({ autoStart = false }: MathPlanPageShellProps) {
  return (
    <div
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-6xl">
        <MathWeeklyPlanSession problemSets={MATH_PLAN_PROBLEM_SETS} autoStart={autoStart} />
      </div>
    </div>
  )
}
