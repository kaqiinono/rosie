  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-amber-200 bg-gradient-to-br from-amber-50 to-[#fef3c7] p-4">
        <div className="mb-1 text-sm font-extrabold text-amber-900">📒 附加题 · 第50讲</div>
        <div className="mb-2 text-xs text-amber-700">{total}道终极挑战 · 分段计费·最值·逻辑推理</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/50/supplement" />
    </div>
  )
}
