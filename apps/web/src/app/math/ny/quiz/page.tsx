        ...
        <>
                ...
                <div className="mx-auto max-w-2xl px-4 py-5">
                        ...
                        {i + 1}
                          ...
                          <span className="text-[11px] font-semibold text-indigo-600">
                            ...
                            {SECTION_INFO[section].icon}
                                                    ...
                                                    <span
                                                        className="text-[11px] text-slate-400">{problem.tagLabel}</span>
                                                    <span
                    ...
                    <div>
                        ...
                        {papers.length === 0 ? (
                            ...
                            >
                                <div
                                    className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-indigo-50">
                                    <svg
                                        width="22"
                                        height="22"
                                        viewBox="0 0 24 24"
            ...
            {modalOpen && (
                ...
                >
                    ...
                    >
                        <div
                            className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-100 bg-white px-5 py-4">
                                                            ...
                                                            <div
                                                                ...
                                                                {modalMode === 'random' && (
                                                                    <div className="flex shrink-0 items-center gap-1">
                                                                        ...
                                                                        <span
                                                                            className="w-5 text-center text-xs font-bold tabular-nums text-slate-700">
                                  {count}
                                </span>
                                                                        <button
                                                                            type="button"
                                                                        ...
                                                                        <span
                                                                            className="ml-0.5 text-[11px] text-slate-400">道</span>
                                                                    </div>
                                                                )}
                                                            </div>
                        ...
                        <div
                            className="sticky bottom-0 flex items-center justify-between gap-2 border-t border-slate-100 bg-white px-5 py-4">
                            {modalMode === 'random' ? (
                                <>
                        ...
                        <div className="flex flex-col gap-1.5 px-5 py-4">
                          ...
                          <span
                            ...
                            {entry.problem.tagLabel}
                                                    ...
                                                    {isCurrent && (
                                                        <span
                                                            className="text-[10px] font-semibold text-indigo-600">当前</span>
                                                    )}
                                                    {usedElsewhere && (
