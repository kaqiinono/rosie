// Extracted from 02 The Knight at Dawn - Mary Pope Osborne.pdf.
// Story body: PDF pages 10-48; pages 49-54 are a preview of volume 3.
import type { StoryVolume } from './story-types'

export const knightAtDawn: StoryVolume = {
  slug: 'the-knight-at-dawn',
  number: 2,
  title: 'The Knight at Dawn',
  description:
    'Jack and Annie travel to the Middle Ages, explore a castle, and meet a mysterious knight.',
  chapters: [
    {
      key: 'ch01',
      number: 1,
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'He dropped the castle book into his pack. He stepped onto the ladder. And headed down into the cool, misty air. Annie was under the tree, looking across the foggy ground.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'He saw Annie dashing across the real drawbridge. Then she vanished through the gate leading to the castle. “I’m going to kill her,” muttered Jack.',
        ...
        'Suddenly, someone shouted behind them. Jack whirled around. A man carrying a tray of pies was standing a few feet away. “Who art thou?” he asked angrily. “Jack,” squeaked Jack. “Annie,” squeaked Annie. Then they ran as fast as they could down a dimly lit hallway.',
      ],
      glossary: [],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Someone grabbed him by the arm. The next thing he knew, his helmet was yanked off. He was staring into the blazing light of a fiery torch. In the torchlight, Jack saw three huge men standing over him.',
        ...
        'Jack went. Down they marched, down the long, dark hallway. Squinty, Annie, Mustache, Jack, and Red. Down a narrow, winding staircase.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Annie reached for Jack’s hands. “I can’t hold you!” she said. Jack felt his fingers slipping. Then down he fell. Down through the darkness. SPLASH!',
      ],
      glossary: [],
    },
    {
      ...
      paragraphs: [
        ...
        '“Oh, man,” Jack said.',
        'He was shivering all over. His teeth were chattering. He shook the water off his glasses and put them back on. It was so misty he couldn’t see the castle. He couldn’t even see the moat, much less a crocodile. “We … we made it,” said Annie. Her teeth were chattering, too.',
