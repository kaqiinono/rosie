  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-purple-200 bg-gradient-to-br from-purple-50 to-[#f3e8ff] p-4">
        <div className="mb-1 text-sm font-extrabold text-purple-900">📚 拓展练习 · 第47讲</div>
        <div className="mb-2 text-xs text-purple-700">{total}道题 · 对角线·锯齿·九宫综合挑战</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/47/workbook" />
    </div>
  )
}
