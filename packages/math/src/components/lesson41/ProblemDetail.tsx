...
import { TAG_STYLE } from '@rosie/math/utils/lesson41-data'
...
export default function ProblemDetail({ problem, mode = 'full', defaultSolutionOpen = false }: ProblemDetailProps) {
  ...
  const { solveCount, handleSolve, addWrong } = useLesson41()
  ...
  const solution = (
    <div className="mb-3.5 rounded-lg border border-[#bae6fd] bg-gradient-to-br from-[#f0f9ff] to-[#e0f2fe] p-3.5">
