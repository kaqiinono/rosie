  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-purple-200 bg-gradient-to-br from-purple-50 to-[#ede9fe] p-4">
        <div className="mb-1 text-sm font-extrabold text-purple-900">📚 练习册 · 第23讲</div>
        <div className="mb-2 text-xs text-purple-700">{total}道闯关题 · 综合逻辑挑战</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/23/workbook" />
    </div>
  )
}
