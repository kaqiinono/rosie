...
import { TAG_STYLE } from '@rosie/math/utils/lesson12-data'
...
export default function ProblemDetail({ problem, mode = 'full', defaultSolutionOpen = false }: ProblemDetailProps) {
  ...
  const { solveCount, handleSolve, addWrong } = useLesson12()
  ...
  const solution = (
    <div className="mb-3.5 rounded-lg border border-orange-200 bg-orange-50 p-3.5">
