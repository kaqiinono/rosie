...
import Lesson53Provider, { useLesson53 } from '@rosie/math/components/lesson53/Lesson53Provider'
import AppHeader from '@rosie/math/components/lesson53/AppHeader'
import Sidebar from '@rosie/math/components/lesson53/Sidebar'
import BottomNav from '@rosie/math/components/lesson53/BottomNav'
...
function getNextHref(pathname: string): string | undefined {
  ...
  return `/math/ny/53/${section}/${index + 1}`
}

function InnerLayout({ children }: { children: React.ReactNode }) {
  const { toast, setToast, showCongrats, setShowCongrats } = useLesson53()
...
export default function Lesson53Layout({ children }: { children: React.ReactNode }) {
  return (
    <Lesson53Provider>
