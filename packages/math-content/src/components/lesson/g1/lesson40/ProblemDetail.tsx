...
import { TAG_STYLE } from '@rosie/math-content/utils/g1/lesson40-data'
...
export default function ProblemDetail({
  ...
  const { practiceCount, correctCount, handleSolve, addWrong } = useG1Lesson40()
  ...
  const question = (
    <div className="flex flex-col gap-1.5">
      ...
      {problem.figureNode && <ProblemFigureImage problem={problem} />}
    </div>
  )
