...
export default function FavoriteHeart({ problemId, size = 'md' }: FavoriteHeartProps) {
  ...
  return (
    <button
      ...
      className={`flex ${dim} shrink-0 cursor-pointer items-center justify-center rounded-full border-none bg-transparent leading-none transition-transform duration-150 ease-out hover:scale-110 active:scale-75`}
    >
