  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-green-200 bg-gradient-to-br from-green-50 to-[#dcfce7] p-4">
        <div className="mb-1 text-sm font-extrabold text-green-900">✏️ 课后巩固 · 第43讲</div>
        <div className="mb-2 text-xs text-green-700">{total}道巩固题 · 求项/求和/应用强化</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/43/homework" />
    </div>
  )
}
