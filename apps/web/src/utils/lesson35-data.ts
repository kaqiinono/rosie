...
const RAW_PROBLEMS: ProblemSet = {
    pretest: [
        {
            id: 'P1', title: '测1 · 打字员', tag: 'type2', tagLabel: '直接倍比', difficulty: 1,
        ...
        {
            id: 'P2', title: '测2 · 圆珠笔', tag: 'type1', tagLabel: '求中间量', difficulty: 2,
        ...
        {
            id: 'P3', title: '测3 · 植树（双归一）', tag: 'type3', tagLabel: '双归一', difficulty: 2,
        ...
        {
            id: 'P4', title: '测4 · 加工零件（双归一）', tag: 'type3', tagLabel: '双归一', difficulty: 2,
        ...
        {
            id: 'P5', title: '测5 · 路灯（变化双归一）', tag: 'type5', tagLabel: '变化双归一', difficulty: 4,
    ...
    lesson: [
        {
            ...
            hasBlocks: true,
            blockScene: {init: 2, perPart: 3, unit: 1, target: 5, answer: 15, total: 6, leftUnit: '分钟'},
            finalQ: '5分钟一共能折',
            finalUnit: '只纸鹤',
            finalAns: 15,
        },
        {
            id: 'L2', title: '例题1b · 装订书', tag: 'type1', tagLabel: '求中间量', difficulty: 1,
        ...
        {
            id: 'L3', title: '例题2 · 挖土豆', tag: 'type1', tagLabel: '非整除归一', difficulty: 2,
        ...
        {
            id: 'L4', title: '例题3 · 搬大米（双归一）', tag: 'type3', tagLabel: '双归一', difficulty: 2,
        ...
        {
            id: 'L5', title: '例题5 · 运钢材（反向双归一）', tag: 'type4', tagLabel: '反向双归一', difficulty: 2,
        ...
        {
            id: 'L6', title: '例题6 · 水龙头（变化双归一）', tag: 'type5', tagLabel: '变化双归一', difficulty: 4,
    ...
    homework: [
        {
            id: 'H1', title: '巩固1 · 种树', tag: 'type1', tagLabel: '基础归一', difficulty: 3,
        ...
        {
            id: 'H2', title: '巩固2 · 背单词', tag: 'type1', tagLabel: '基础归一', difficulty: 3,
        ...
        {
            id: 'H3', title: '巩固3 · 汽车零件', tag: 'type3', tagLabel: '双归一', difficulty: 3,
        ...
        {
            id: 'H4', title: '巩固4 · 运沙石', tag: 'type3', tagLabel: '双归一', difficulty: 3,
        ...
        {
            id: 'H5', title: '巩固5 · 缝纫师', tag: 'type4', tagLabel: '反向双归一', difficulty: 3,
        ...
        {
            id: 'H6', title: '巩固6 · 电灯（变化双归一）', tag: 'type5', tagLabel: '变化双归一', difficulty: 4,
    ...
    workbook: [
        {
            id: 'W1', title: '闯关1 · 磨面粉', tag: 'type1', tagLabel: '基础归一+加法', difficulty: 3,
        ...
        {
            id: 'W2', title: '闯关2 · 做练习题', tag: 'type1', tagLabel: '直接倍比', difficulty: 3,
        ...
        {
            id: 'W3', title: '闯关3 · 蜂箱', tag: 'type2', tagLabel: '直接倍比+增加', difficulty: 3,
        ...
        {
            id: 'W4', title: '闯关4 · 加工零件', tag: 'type3', tagLabel: '双归一+反向', difficulty: 3,
        ...
        {
            id: 'W5', title: '闯关5 · 摘桃子', tag: 'type4', tagLabel: '归一+增加人数', difficulty: 3,
        ...
        {
            id: 'W6', title: '闯关6 · 奶牛产奶', tag: 'type3', tagLabel: '双归一', difficulty: 3,
        ...
        {
            id: 'W7', title: '闯关7 · 修路', tag: 'type3', tagLabel: '反向双归一', difficulty: 3,
        ...
        {
            id: 'W8', title: '闯关8 · 增加零件', tag: 'type5', tagLabel: '双归一+增加量', difficulty: 4,
        ...
        {
            id: 'W9', title: '闯关9 · 大卡车运沙', tag: 'type4', tagLabel: '反向双归一', difficulty: 3,
        ...
        {
            id: 'W10', title: '闯关10 · 制作零件（变化双归一）', tag: 'type5', tagLabel: '变化双归一', difficulty: 4,
        ...
        {
            id: 'W11', title: '闯关11 · 加工零件（变化双归一）', tag: 'type5', tagLabel: '变化双归一', difficulty: 5,
        ...
        {
            id: 'W12', title: '闯关12 · 粉笔（最难）', tag: 'type5', tagLabel: '综合变化', difficulty: 5,
