...
import ProblemList from '@rosie/math/components/lesson46/ProblemList'
  ...
  return (
    <div>
      <div className="mb-3.5 rounded-[14px] border border-teal-200 bg-gradient-to-br from-teal-50 to-[#ccfbf1] p-4">
        <div className="mb-1 text-sm font-extrabold text-teal-900">📒 附加题 · 第46讲</div>
        <div className="mb-2 text-xs text-teal-700">{total}道附加题 · 完全相同·三花色</div>
      ...
      <ProblemList problems={list} solveCount={solveCount} basePath="/math/ny/46/supplement" />
    </div>
  )
}
